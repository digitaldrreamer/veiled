...
Veiled qualifies for multiple Privacy Hack bounties:

### Track 02: Privacy Tooling ($15k)
✅ Infrastructure for developers
✅ SDK + libraries + framework
✅ Makes privacy easier to adopt

### Helius Bounty ($5k)
✅ Uses Helius RPC for enhanced data
✅ WebSocket integration
✅ Best privacy project
...
✅ Built with Noir circuits
✅ Best non-financial use case (auth!)
✅ Creative ZK application

### Range Compliance ($1.5k)
✅ Selective disclosure integration
✅ Compliance-first design
✅ Pre-screening support

**Total potential: $36k+ in prizes**
...
- **[Integration Guide](./docs/INTEGRATION_GUIDE.md)** - How to add Veiled to your dApp
- **[Circuit Design](./docs/CIRCUIT_DESIGN.md)** - ZK circuit specifications
- **[Research](./docs/RESEARCH.md)** - Learning resources and development notes
