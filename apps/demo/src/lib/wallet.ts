// * Wallet adapter wrapper for SvelteKit
// * Bridges Solana wallet adapters to Veiled's WalletAdapter interface

import type { WalletAdapter as SolanaWalletAdapter } from '@solana/wallet-adapter-base';
import type { PublicKey } from '@solana/web3.js';
import type { WalletAdapter } from '@veiled/core';

/**
 * * Creates a Veiled-compatible wallet adapter from a Solana wallet adapter
 */
